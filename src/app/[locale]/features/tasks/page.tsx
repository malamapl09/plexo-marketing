...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "FeaturesTasksPage" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates("/features/tasks", locale),
  };
}
...
export default async function TasksPage({ params }: Props) {
  ...
  const t = await getTranslations("FeaturesTasksPage");
