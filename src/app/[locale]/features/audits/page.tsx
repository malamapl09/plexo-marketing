...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "FeaturesAuditsPage" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates("/features/audits", locale),
  };
}
...
export default async function AuditsPage({ params }: Props) {
  ...
  const t = await getTranslations("FeaturesAuditsPage");
