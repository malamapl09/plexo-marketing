...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "FeaturesGamificationPage" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: getAlternates("/features/gamification", locale),
  };
}
...
export default async function GamificationPage({ params }: Props) {
  ...
  const t = await getTranslations("FeaturesGamificationPage");
