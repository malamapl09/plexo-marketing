...
export const metadata: Metadata = {
  title: "Training & LMS — Plexo",
  description:
    "Deliver bite-sized training content, track completions, and certify your retail workforce — all from the same platform they use every day.",
};
...
const capabilities = [
  {
    ...
    desc: "Short, focused lessons that staff can complete between customers.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Test knowledge retention with auto-graded quizzes after each module.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Track certifications, set expiry dates, and auto-remind for renewals.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Assign different training paths to cashiers, managers, and warehouse staff.",
    icon: (
      <svg
        width="24"
        height="24"
...
export default function TrainingPage() {
  return (
    <FeaturePageLayout
      badge="Training & LMS"
      title="Train your teams without pulling them off the floor."
      subtitle="Deliver bite-sized training content, track completions, and certify your workforce &mdash; all from the same platform they use every day."
