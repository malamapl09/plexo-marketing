...
export const metadata: Metadata = {
  title: "Issue Tracking — Plexo",
  description:
    "Give every team member a fast way to report issues. Automatically categorize, assign, and track resolution with full SLA visibility.",
};
...
const capabilities = [
  {
    ...
    desc: "Any team member can report an issue in seconds from their phone.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Auto-categorize issues by type and route to the right team.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    title: "SLA tracking",
    desc: "Set resolution targets by priority and track compliance automatically.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Auto-escalate unresolved issues to managers after defined thresholds.",
    icon: (
      <svg
        width="24"
        height="24"
...
export default function IssueTrackingPage() {
  return (
    <FeaturePageLayout
      ...
      title="Report it, route it, resolve it."
      subtitle="Give every team member a fast way to report issues. Automatically categorize, assign, and track resolution with full SLA visibility."
