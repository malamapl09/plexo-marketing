...
export const metadata: Metadata = {
  title: "Checklists & SOPs — Plexo",
  description:
    "Build reusable checklists and standard operating procedures that ensure consistency across all retail locations. Every step documented, every completion tracked.",
};
...
const capabilities = [
  {
    ...
    desc: "Build once, deploy to every store. Create templates for any process and roll them out instantly across all locations.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    desc: "Show or hide steps based on previous answers for dynamic checklists that adapt to real-world situations on the floor.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    desc: "Require evidence at critical steps for compliance proof. Attach photos and collect digital signatures directly in the app.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    desc: "Track which stores complete checklists on time and which don't. Spot compliance gaps before they become costly problems.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
...
export default function ChecklistsPage() {
  return (
    <FeaturePageLayout
      badge="Checklists & SOPs"
      title="Standardize every process, in every store."
      subtitle="Build reusable checklists and standard operating procedures that ensure consistency across all locations. Every step documented, every completion tracked."
