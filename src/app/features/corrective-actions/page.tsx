...
export const metadata: Metadata = {
  title: "Corrective Actions (CAPA) — Plexo",
  description:
    "Automatically turn failed audit items into corrective action plans with owners, deadlines, severity classification, and verification workflows — so nothing slips through the cracks.",
};
...
const capabilities = [
  {
    title: "Auto-generated from audits",
    desc: "Failed audit items automatically become corrective actions with full context — store, auditor, and the specific finding — so nothing needs to be manually re-entered.",
    icon: (
  ...
  },
  {
    ...
    desc: "Categorize issues as Critical, Major, or Minor to surface the right items first. Filters, sorting, and dashboards all reflect severity so your team always knows what demands immediate action.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width={24} height={24}>
  ...
  },
  {
    ...
    desc: "Document the underlying root cause and the preventive measures taken for every CAPA. Identify recurring patterns across stores before they become systemic problems.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width={24} height={24}>
  ...
  },
  {
    ...
    desc: "Require photo evidence and manager sign-off before a CAPA can be closed. Every resolution is timestamped and auditable, giving you an unbreakable chain of accountability.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width={24} height={24}>
...
export default function CorrectiveActionsPage() {
  return (
    <FeaturePageLayout
      badge="Corrective Actions"
      title="Find it, fix it, prove it — automatically."
      subtitle="When audits or inspections reveal issues, Plexo automatically creates corrective action plans with owners, deadlines, and follow-up verification."
