...
export const metadata: Metadata = {
  title: "Campaign Execution — Plexo",
  description:
    "Roll out marketing campaigns, seasonal promotions, and merchandising initiatives across all stores — and track execution in real time.",
};
...
const capabilities = [
  {
    ...
    desc: "Push campaigns to all stores or target specific regions and locations.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Break campaigns into tasks with clear instructions and deadlines.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "Require stores to upload proof of execution before marking complete.",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  },
  {
    ...
    desc: "See which stores have executed and which are falling behind instantly.",
    icon: (
      <svg
        width="24"
        height="24"
...
export default function CampaignsPage() {
  return (
    <FeaturePageLayout
      ...
      title="Launch campaigns that actually get executed."
      subtitle="Roll out marketing campaigns, seasonal promotions, and merchandising initiatives across all stores &mdash; and track execution in real time."
