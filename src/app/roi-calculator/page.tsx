        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-slate-900 leading-tight">
              Calculate Your ROI with Plexo
            </h1>
            <p className="mt-3 text-lg text-slate-500 max-w-xl mx-auto leading-relaxed">
              See how much time and money Plexo can save your retail operation.
            </p>
          </div>
          ...
          {view === "form" && (
            <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 sm:p-8">
              ...
              <div className="space-y-8">
                ...
                <SliderField
                  id="hours-per-store"
                  label="Hours spent weekly on manual operations per store"
              ...
              <div className="mt-8 p-4 rounded-xl bg-indigo-50 border border-indigo-100">
                ...
                <p className="text-slate-700 text-sm leading-relaxed">
                  Based on your inputs, Plexo could save your team roughly{" "}
                  <span className="font-bold text-indigo-700">
                    {formatNumber(results.weeklyHoursSaved)} hours per week
                  </span>{" "}
                  — worth{" "}
                  <span className="font-bold text-indigo-700">
                    {formatDollars(results.annualSavings)} annually
                  </span>
                  .
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 p-6 sm:p-8 text-white">
                ...
                <p className="text-4xl sm:text-5xl font-bold tabular-nums leading-tight">
                  {formatDollars(results.annualSavings)}
                </p>
                <p className="text-indigo-200 mt-2 text-sm">
                  per year across {inputs.stores.toLocaleString("en-US")}{" "}
                  {inputs.stores === 1 ? "store" : "stores"} — based on a 60%
                  efficiency gain from automating manual operations
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <ResultCard
                  ...
                  value={formatNumber(results.weeklyHoursSaved)}
                  sublabel="Across all stores, every week"
                  accent="bg-indigo-50"
                  icon={IconClock}
                />
                <ResultCard
                  ...
                  sublabel="Recovered labor cost per month"
                ...
                <ResultCard
                  label="Time to ROI"
                  value="Under 30 days"
                  sublabel="Most customers break even in week 1"
                  accent="bg-amber-50"
                  icon={IconRocket}
                />
              </div>
              ...
              <p className="text-xs text-slate-400 text-center px-4">
                Estimates assume a 60% reduction in manual operation hours
                following Plexo onboarding. Individual results may vary.
              </p>
              ...
              <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-6 sm:p-8">
                ...
                <p className="text-sm text-slate-500 mt-1 mb-5">
                  We will send a detailed breakdown straight to your inbox,
                  tailored to your {inputs.stores}-store operation.
                </p>
              ...
              <div className="mt-4 rounded-xl bg-slate-900 p-6 sm:p-8 text-center">
                ...
                <p className="text-slate-400 text-sm mt-1 mb-5">
                  See Plexo in action with a live demo tailored to your retail
                  chain.
                </p>
                <a
                  href="/demo"
