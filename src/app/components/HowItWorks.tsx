const steps = [
  {
    number: "01",
    title: "Set up your stores and teams",
    desc: "Add your locations, invite your managers and staff. Organize by region, district, or brand. Takes minutes, not days.",
    icon: (
  ...
  {
    number: "02",
    title: "Assign tasks, checklists, and campaigns",
    desc: "Create recurring tasks, schedule audits, launch campaigns. Everything gets assigned with clear owners and deadlines.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    desc: "See what's done, what's overdue, and who's leading — across every store, from anywhere, on any device.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-lg text-slate-600">
            No complex setup. No lengthy onboarding. Get your first store live today.
          </p>
        </div>
